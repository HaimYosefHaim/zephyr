...
The EFM32 Pearl Gecko Starter Kit EFM32PG-DK2503A contains an MCU from the
EFM32PG family built on an ARM® Cortex®-M33F processor with low
power capabilities.

.. figure:: efm32pg_dk2503a.jpg
   :align: center
   :alt: EFM32PG-DK2503A

   EFM32PG-DK2503A (image courtesy of Silicon Labs)
...
For more information about the EFM32PG SoC and EFM32PG-DK2503A board:

- `EFM32PG Website`_
- `EFM32PG22 Datasheet`_
- `EFM32PG22 Reference Manual`_
- `EFM32PG-DK2503A Website`_
- `EFM32PG-DK2503A User Guide`_
- `EFM32PG-DK2503A Schematics`_

Supported Features
==================

The efm32pg_dk2503a board configuration supports the following hardware features:
...
The default configuration can be found in the defconfig file:
	...
	``boards/arm/efm32pg_dk2503a/efm32pg_dk2503a_defconfig``

Other hardware features are currently not supported by the port.

EFM32 Pearl Gecko SoC
--------------------

The EFM32 Pearl Gecko Starter Kit EFM32PG-DK2303A can also be used to evaluate
